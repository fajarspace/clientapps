...
import CreatePengabdianForm from "./formData";
...
import { bidangOptions } from "../../penelitian/create/data";

const { Step } = Steps;
const { Option } = Select;

const CreatePengabdian: React.FC = () => {
  const {
  ...
  const handleNext = () => {
    ...
    if (currentStep === 2) {
      if (!formData.judul_pengabdian || !formData.bidang) {
        setValidationError("Data jangan ada yang kosong!.");
        return;
      }
    }
      ...
      content: (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Input
            ...
            variant="bordered"
            value={formData.judul_pengabdian}
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <div>
            <h4 className="font-semibold mb-2">Judul Pengabdian & Bidang:</h4>
            <table className="w-full border border-gray-300">
              <tbody>
                <tr className="border-b border-gray-300">
                  <td className="font-semibold p-2">Judul Pengabdian:</td>
                  <td className="p-2">{formData.judul_pengabdian}</td>
                </tr>
                <tr className="border-b border-gray-300">
                  <td className="font-semibold p-2">Bidang Pengabdian:</td>
...
export default CreatePengabdian;
