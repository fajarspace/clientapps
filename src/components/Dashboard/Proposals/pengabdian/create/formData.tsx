// components/CreatePengabdianForm.tsx
"use client";
import React, { useState, useEffect } from "react";
import { useMutation } from "@apollo/client";
import { toast } from "react-toastify";
import { useUser } from "../../../../hooks/useUser";
import { CREATE_PENGABDIAN } from "../../../../../graphql/actions/pengabdian.action";
...
const CreatePengabdianForm = () => {
  ...
  const [createPengabdian, { loading, error }] = useMutation(CREATE_PENGABDIAN);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      await createPengabdian({
        variables: {
          createPengabdianInput: {
            judul_pengabdian: formData.judul_pengabdian,
      ...
      Navigate("/dashboard/pengabdian");
    } catch (error) {
      console.error("Error adding pengabdian:", error);
      toast.error("Failed to add pengabdian");
    }
  };
...
export default CreatePengabdianForm;
